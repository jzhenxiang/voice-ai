...
class IntegrationBridge(GRPCBridge):
    async def get_embedding(
        self, auth_token: str, provider_name: str, request: EmbeddingRequest
        ...
        provider_stub_map = {
            ...
            "azure-foundry": integration_api_pb2_grpc.AzureServiceStub,
            "gemini": integration_api_pb2_grpc.GeminiServiceStub,
        ...
        if provider_name in provider_stub_map:
            ...
            raise BridgeException(
                message="Unsupported provider name.", bridge_name="integration"
            )
        ...
        if not result or not result.success:
            raise BridgeException(
                message="Failed to retrieve embedding response.",
                bridge_name="integration",
            )
